...
Η εφαρμογή φιλοδοξεί να αποτελέσει ένα ανοιχτό εργαλείο για την κοινότητα, ενισχύοντας τη συμμετοχή των πολιτών στη διατήρηση και ανάδειξη της πολιτιστικής κληρονομιάς της πόλης.

---

## **Σκοπός και Στόχοι**

Ο βασικός σκοπός της εργασίας είναι η ανάπτυξη μιας διαδικτυακής εφαρμογής που θα λειτουργεί ως διαδραστική βάση δεδομένων για τα μνημεία της Θεσσαλονίκης, με έμφαση στη συμμετοχή των χρηστών.
...
Η ανάγκη για την καταγραφή και ανάδειξη των μνημείων μιας πόλης έχει οδηγήσει στην ανάπτυξη διαφόρων ψηφιακών εφαρμογών και πλατφορμών, τόσο σε τοπικό όσο και σε διεθνές επίπεδο.

Στην Ελλάδα, υπάρχουν εφαρμογές όπως το "Μνημεία της Ελλάδας" και το "Clio Muse", που προσφέρουν πληροφορίες για μνημεία και πολιτιστικά σημεία ενδιαφέροντος, κυρίως με τη μορφή στατικών πληροφοριών ή προκαθορισμένων διαδρομών. Παράλληλα, αρκετοί δήμοι και πολιτιστικοί φορείς διατηρούν δικές τους βάσεις δεδομένων ή ιστοσελίδες με πληροφορίες για τα μνημεία της περιοχής τους.
...
Η εφαρμογή Monuma έρχεται να καλύψει αυτό το κενό, προσφέροντας μια εξειδικευμένη, ανοιχτή και διαδραστική πλατφόρμα για τα μνημεία της Θεσσαλονίκης, με έμφαση στη συμμετοχή και τη συνεργασία της κοινότητας.
